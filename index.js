...
// Make sure to console log all 3 titles (after you get the data retrieve the nested values) 
 let requestUrl = "https://api.artic.edu/api/v1/artworks/search?q=dog&size=3"
...
async function searchArtworks(search, size){
    let requestUrl = "https://api.artic.edu/api/v1/artworks/search?q="
    requestUrl += search + "&size=" + size
